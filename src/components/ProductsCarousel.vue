      ...
      <div class="col">
        <div class="card">
          ...
          >
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img
                  src="../assets/images/addidasone.jpg"
                  class="d-block w-100"
                  alt="..."
                />
              </div>
              <div class="carousel-item">
                <img
                  src="../assets/images/vans-skate-old-skool-shoes-black-white-1.jpg"
                  class="d-block w-100"
                  alt="..."
                />
              </div>
          ...
          <div class="card-body">
            ...
            <p class="card-text">Something about our shoes.</p>
            <router-link
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Something about our pants.</p>
            <router-link
              class="btn btn-outline-primary me-2"
              :to="{ name: 'Products' }"
              >View
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Something about our Sweaters.</p>
            <router-link
              class="btn btn-outline-primary me-2"
              :to="{ name: 'Products' }"
              >View
